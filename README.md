...
[![NPM version](https://img.shields.io/npm/v/embedhq.svg)](https://npmjs.org/package/embedhq) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/embedhq)
...
To do the inverse, add `import "embedhq/shims/node"` (which does import polyfills).
...
- Deno v1.28.0 or higher, using `import Embed from "npm:embedhq"`.
- Bun 1.0 or later.
- Cloudflare Workers.
- Vercel Edge Runtime.
