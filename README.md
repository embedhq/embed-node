...
```sh
npm install git+ssh://git@github.com:stainless-sdks/embed-node.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainlessapi.com/docs/guides/publish), this will become: `npm install embed`
...
To do the inverse, add `import "embed/shims/node"` (which does import polyfills).
This can also be useful if you are getting the wrong TypeScript types for `Response` ([more details](https://github.com/stainless-sdks/embed-node/tree/main/src/_shims#readme)).
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/embed-node/issues) with questions, bugs, or suggestions.
...
- Deno v1.28.0 or higher, using `import Embed from "npm:embed"`.
- Bun 1.0 or later.
- Cloudflare Workers.
- Vercel Edge Runtime.
