...
```sh
npm install git+ssh://git@github.com:embedhq/embed-node.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainlessapi.com/docs/guides/publish), this will become: `npm install @embedhq/node`
...
- Deno v1.28.0 or higher, using `import Embed from "npm:@embedhq/node"`.
- Bun 1.0 or later.
- Cloudflare Workers.
- Vercel Edge Runtime.
